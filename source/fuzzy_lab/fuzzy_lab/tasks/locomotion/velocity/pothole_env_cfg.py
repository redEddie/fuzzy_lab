...
import fuzzy_lab.tasks.locomotion.velocity.mdp as mdp
import fuzzy_lab.tasks.locomotion.velocity.mdp.rewards as rewards

##
# Pre-defined configs
##
from isaaclab.terrains.config.rough import ROUGH_TERRAINS_CFG  # isort: skip
from fuzzy_lab.tasks.locomotion.velocity.pothole_terrains_cfg import POTHOLE_TERRAINS_CFG
...
class Go2SceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=POTHOLE_TERRAINS_CFG,
...
@configclass
class Go2LocomotionVelocityPotholeEnvCfg(ManagerBasedRLEnvCfg):
